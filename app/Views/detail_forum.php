...
<div class="container">
    ...
    <div class="row">
                            ...
                            <div class="row mx-2">
                                ...
                                <div class="col-md-11">
                                    <div class="card-body text-dark">
                                        <h5 class="card-title"><?= $post[0]['nama']; ?> bertanya 45 menit yang lalu</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow-sm w-100 alig">
                            <div class="card-header">4 Jawaban</div>
                            <?php foreach ($komentar->getResultArray() as $k) : ?>
                                ...
                                <?php else : ?>
                                    <div class="col-md-12">
                                        <div class="card-body text-dark">
                                            <h5 class="card-title">
                                                <center>Belum Ada Komentar<center>
                                            </h5>
                                        </div>
                                    </div>
                                <?php endif; ?>
        ...
        <div class="col-md-3">
            <h4>Kategori</h4>
            <button type="button" class="btn btn-outline-primary w-100 custom-outline-btn">Primary</button>
            <button type="button" class="btn btn-outline-primary w-100 custom-outline-btn">Primary</button>
            <button type="button" class="btn btn-outline-primary w-100 custom-outline-btn">Primary</button>
            <button type="button" class="btn btn-outline-primary w-100 custom-outline-btn">Primary</button>
            <button type="button" class="btn btn-outline-primary w-100 custom-outline-btn">Primary</button>
